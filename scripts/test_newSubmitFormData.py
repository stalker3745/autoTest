...
# 登录的测试步骤
def test_SubmitFormData(SubmitFormData_data,getHeaders, url, br, db_info):
    # 删除多余数据
    db.updata_formentity(db_info, SubmitFormData_data['appidend'])
    r=member.newGetFormDetailData(url, getHeaders, br,SubmitFormData_data['getlog'])
    ...
    "isEdit": "true",
    "isAdminEdit": "true"}
    r1=member.newSubmitFormData(url, getHeaders, br,SubmitFormData_data1)
    ...
    SubmitFormData_data1 = {
        # "formMetaDataDetailsVO": formMetaDataDetailsVO,
                   ...
                   "isEdit": "true",
                   "isAdminEdit": "true"}
    r=member.newGetFormDetailData(url, getHeaders, br,SubmitFormData_data1)
    SubmitFormData_data1 = {"formMetaDataDetailsVO": formMetaDataDetailsVO,
                            "appId": appId,
                            "companyId": companyId,
